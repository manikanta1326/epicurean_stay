...
<div class="admin-booking">
        <h1 class="admin-book"> <Section>contact-us</Section></h1>
        <table>
            <tr>
                    ...
                    <th width="10%" height="50px">Message</th>
               ...
               $run=mysqli_query($sql,$qry);
                 ...
                 while( $row=mysqli_fetch_assoc($run))
                 {
                    ...
                    <tr>
                     ...
                     <td width="10%" height="50px"><center><?php echo $mobile; ?></center></td>
                     <td width="10%" height="50px"><center><?php echo $address; ?></center></td> 
                     <td width="10%" height="50px"><center><?php echo $message; ?></center></td>
                 </tr>
