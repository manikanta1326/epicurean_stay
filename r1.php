...
// Check if each key exists in the $_GET array before accessing it
$ci = isset($_GET['ci']) ? $_GET['ci'] : null;
$co = isset($_GET['co']) ? $_GET['co'] : null;
$rt = isset($_GET['rt']) ? $_GET['rt'] : null;
$nr = isset($_GET['nr']) ? $_GET['nr'] : null;

// Optional: Handle the case where any of these values are not set
// if ($ci === null || $co === null || $rt === null || $nr === null) {
//     echo "One or more query parameters are missing.";
// }
?>
...
<body>
    <div id="r1-container">
    <center><h1>Please Fill Up The Form Given Below</h1></center>
