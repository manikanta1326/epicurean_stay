...
<div id="f1">
    <h2 class="room-h2"><i class="fas fa-hotel"></i> SEARCH YOUR ROOMS HERE</h2>
         ...
         <?php
    // Check if 'room' is set in the URL query parameters
    $r = isset($_GET['room']) ? $_GET['room'] : null;
    
    // Check if 'ci' is set in the URL query parameters
    $ci = isset($_GET['ci']) ? $_GET['ci'] : null;
    
    // Check if 'co' is set in the URL query parameters
